    ...
    <div className="flex min-h-screen">
      <div className="from-primary/10 via-primary/5 to-background hidden w-1/2 items-center justify-center bg-gradient-to-br p-8 lg:flex">
        <div className="flex flex-col items-center gap-6">
          <div className="bg-primary/10 text-primary flex size-28 items-center justify-center rounded-2xl text-3xl font-bold tracking-tight shadow-sm ring-1 ring-primary/20">
            RF
          </div>
